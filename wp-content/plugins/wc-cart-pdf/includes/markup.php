...
function wc_cart_pdf_button() {
	...
	<a href="<?php echo esc_url( wp_nonce_url( add_query_arg( array( 'cart-pdf' => '1' ), wc_get_cart_url() ), 'cart-pdf' ) ); ?>" class="cart-pdf-button button" target="_blank"><i class="fa fa-file-pdf"></i> 
		<?php echo esc_html( get_option( 'wc_cart_pdf_button_label', __( 'Download PDF', 'wc-cart-pdf' ) ) ); ?>
	</a>
